defmodule FireemblemlegacyWeb do
  @moduledoc """
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: FireemblemlegacyWeb
      import Plug.Conn
  ...
  def view do
    quote do
      use Phoenix.View, root: "lib/fireemblemlegacy_web/templates",
                        namespace: FireemblemlegacyWeb
